...
using NeuralNetCore.Functions;
using NeuralNetCore.Functions.ActivationFunctions;
using NeuralNetCore.Functions.InputFunctions;

namespace NeuralNetCore.Structure
{
    class Neuron
    {
